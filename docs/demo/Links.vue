<template>
    ...
    :items="[
      {
        ...
        size: 48,
        name: 'iconify',
        desc: 'Open source icon library, providing thousands of vector icons, supporting multiple frameworks and platforms. It allows developers to easily use various icons in their projects and supports light/dark mode switching.'
      }
    ]"
  />
  ...
  <Links
    :grid="3"
    :items="[
      // iconify icons with light/dark mode + v-html rendering
      {
        ...
        desc: 'Serverless deployment platform for front-end frameworks, supporting static generation and instant preview.',
        link: 'https://vercel.com/'
      },
      // iconify icons with light/dark mode, no color
      {
        icon: { light: 'skill-icons:vite-dark', dark: 'skill-icons:vite-light' },
        name: 'Vite',
        desc: 'Lightning-fast modern front-end build tool, supporting hot module replacement and on-demand loading.',
        link: 'https://vitejs.dev/'
      },
      // no icon
      {
        name: 'MDN Web Docs',
        desc: 'Authoritative Web technology documentation repository, covering HTML, CSS, and JavaScript.',
  ...
  <Links
    ...
    :items="[
      // svg icon
      {
        ...
        name: 'Pinia',
        desc: 'State management library for Vue 3, concise and with type inference support.',
        link: 'https://pinia.vuejs.org/'
      },
      // light/dark mode svg icon
      {
        icon: {
          svg: {
        ...
        name: 'Netlify',
        desc: 'Frontend deployment platform offering CI/CD, automatic builds, and serverless functions.',
  ...
  <Links
    ...
    :items="[
      // normal image
      {
        ...
        name: 'Alipay',
        desc: 'Mobile payment platform providing convenient online payment and transfer services',
        link: 'https://i.theojs.cn/alipay.webp',
        linkText: 'View Now'
      },
      // light/dark mode image
      {
        image: {
        ...
        name: 'GitHub',
        desc: 'World\'s largest code hosting platform, supporting version control and collaborative development.',
